...
import type { DashboardVideoSection } from "@/lib/dashboard-feed"
...
export function VideoCategoryRow({
  section,
  getVoteCount,
  isVoted,
  canVote,
  ...
  return (
    <section className="space-y-4" aria-labelledby={`video-category-${sectionKey}`}>
